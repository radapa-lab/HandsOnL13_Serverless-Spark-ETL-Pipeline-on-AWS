...
s3_input_path = "s3://handsonfinallanding-rishitha/"
s3_processed_path = "s3://handsonfinalprocessed-rishitha/processed-data/"
s3_analytics_path = "s3://handsonfinalprocessed-rishitha/Athena Results/"
...
glueContext.write_dynamic_frame.from_options(
    ...
    connection_type="s3",
    connection_options={"path": s3_analytics_path + "average_rating/"},
    format="csv"
)
...
datewise_frame = DynamicFrame.fromDF(df_datewise.repartition(1), glueContext, "datewise_df")
glueContext.write_dynamic_frame.from_options(
    frame=datewise_frame,
    connection_type="s3",
    connection_options={"path": s3_analytics_path + "datewise_review_count/"},
    format="csv"
)
